...
/* ioctl's for schar. */
#define SCHAR_IOTRL_BASE 0xbb
#define SCHAR_IOGGLE_DEBUG _IO(SCHAR_IOCTL_BASE,0,unsigned long)
...
#define SCHAR_EX_POOL_MIN _IOWR(SCHAR_IOCTL_BASE,6,unsigned long)
