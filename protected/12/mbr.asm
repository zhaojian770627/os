	...
	;; 创建保护模式下初始代码段描述符
	mov	dword[ebx+0x10],0x7c0001ff ;基地址位0x00007c00,512字节
	mov	dword[ebx+0x14],0x00409800 ;粒度为一个字节,代码段描述符

	;; 创建以上代码段的别名描述符
	mov	dword[ebx+0x18],0x7c0001ff ;基地址位0x00007c00,512字节
