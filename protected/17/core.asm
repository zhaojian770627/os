...
.b0:				;EAX=链表头或当前TCB线性地址
	...
	jmp	.b0
.b1:
	mov	word[ebx+0x04],0x3333 ;修改当前任务的状态为退出
.b2:
...
.b3:
	...
	mov	word[esi+0x12],103 ;在TCB中填写TSS界限值
...
.b1:
	mov	[eax],ecx
	mov	dword[ecx],0x00000000 ;当前TCB指针域清0，以指示这是最后一个TCB
